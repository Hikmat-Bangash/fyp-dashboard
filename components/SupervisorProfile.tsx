...
const ProfileCard = () => {
  ...
  const [loading, setloading] = useState(false);
    ...
    const UpdatePhoto = () => {
        console.log("profile pic successfully")
    }
    ...
    <div className=" mt-20 ml-3 flex flex-col justify-center w-[365px] sm:w-[450px] md:w-full  lg-full xl-w-full">
      <div className="flex items-center justify-between mb-2">
        ...
        <h3 className="text-lg -ml-3 font-bold text-primaryColor-500">
          <span
            ...
            className=" text-headingColor-400 opacity-50 font-black"
          >
            Profile Card
          </span>
        </h3>
      ...
      >
        ...
        <h1
          data-testid="supervisor-name"
           className="text-xl text-headingColor-400 font-bold"
        >
          Supervisor Name
        </h1>
      </div>
      ...
      <div className="flex flex-col gap-1 z-0 mt-10 mb-6 ml-8 mr-8">
        ...
        <div className="flex items-center justify-between font-semibold ">
          <h2 data-testid="centered-name" className="text-lg text-gray-500">
            Supervisor Name
          </h2>
          <BiEdit
      ...
      <div className="flex flex-col gap-1 z-0 mt-10 mb-6 ml-8 mr-8">
        ...
        >
          <h2 data-testid="phone" className="text-lg text-gray-500">
            0333434343
          </h2>
      ...
      <div className="flex flex-col gap-1 z-0 mt-10 mb-6 ml-8 mr-8">
        ...
        <div className="flex items-center justify-between font-semibold">
          <h2 data-testid="email" className="text-lg text-gray-500">
            example@gmail.com
          </h2>
          <BiEdit
      ...
      <div className="flex flex-col gap-1 z-0 mt-10 mb-6 ml-8 mr-8">
        ...
        <div className="flex items-center justify-between font-semibold">
          <h2 data-testid="address" className="text-lg text-gray-500">
            your address
          </h2>
          <BiEdit
